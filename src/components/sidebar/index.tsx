...
export const Sidebar = () => {
	...
	return (
		<motion.aside
			...
			className={cn(
				"h-[100svh] overflow-hidden flex flex-col bg-white px-6 py-6 text-md text-gray-500 w-[250px] transition-all duration-300 ease-in-out border-r border-solid shadow",
			)}
